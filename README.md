...
Enemy AI with detection, pursuit, and attack behaviours
Player and enemy health systems with UI health bars
Combat mechanics, including standard and spin attacks
Interactive environments (pressure plates, animated doors, teleporters)
...
Health management with HUD integration
Weapon-based combat using animations
Enemy Systems
Proximity-based enemy detection
Attack behaviours driven by Unity’s Animator
Individual enemy health bars
Environment & Progression
Trigger-based pressure plates controlling animated doors
Teleporters used for level transitions
Collectible coins contributing to player score
UI & Persistence
...
Improving camera and combat animations
